...
//
    ...
    {
        { wxCMD_LINE_SWITCH, ("hide"), ("hide"), ("Start with the the main frame hide.")},
        { wxCMD_LINE_SWITCH, ("notray"), ("notray"),  ("Don't show the icon on system tray")},
        { wxCMD_LINE_OPTION, ("list"), ("list"),  ("Parse a text file with the list of files to download")},
        { wxCMD_LINE_OPTION, ("destination"), ("destination"),  ("Destination directory")},
        { wxCMD_LINE_OPTION, ("comments"), ("comments"),  ("Add comments to download")},
        { wxCMD_LINE_OPTION, ("reference"), ("reference"),  ("Set a reference URL")},
        { wxCMD_LINE_PARAM, NULL, NULL,  ("URL of the file(s) to be downloaded"),wxCMD_LINE_VAL_STRING,wxCMD_LINE_PARAM_OPTIONAL | wxCMD_LINE_PARAM_MULTIPLE},
        { wxCMD_LINE_NONE }
    };
    ...
    public:
                ...
                wxDialog(parent, id, title)
        {
            ...
            grid_sizer->Add(m_btnok, 0, wxALIGN_RIGHT, 0);
            SetAutoLayout(true);
            SetSizer(grid_sizer);
            grid_sizer->Fit(this);
    ...
    public:
        ...
        void SetCurrentSelection(int selection);
        void GenerateList(wxImageList *imageslist);
        static int wxCALLBACK CompareDates(wxIntPtr item1, wxIntPtr item2, wxIntPtr WXUNUSED(sortData));
        mMainFrame *mainframe;
